  ...
  return (
    <Card className="group relative overflow-hidden hover:shadow-lg transition-shadow duration-300">
      <CardContent className="p-0">
        {/* Ảnh sản phẩm */}
        <div className="relative h-36 sm:h-48 aspect-square overflow-hidden w-full">
          <Image
          ...
          {(!!label || (!isDeal && product.expiryDate)) && (
            <div className="absolute top-2 left-2 z-20 flex items-center gap-1 sm:gap-2">
              {/* HSD: chỉ hiển thị khi không phải deal và có expiryDate */}
              {!isDeal && parsedExpiry && (
                <span
                  className={`px-1.5 py-0.5 text-xs font-medium text-white rounded flex items-center gap-1 ${getExpiryBadgeColor()}`}
                >
                  {getExpiryIcon()}
        ...
        <div className="p-3 sm:p-4">
          ...
          <div className="mt-2 w-full">
            <div className="flex items-center justify-center gap-1 sm:gap-2 w-full px-2 py-1 sm:px-3 sm:py-2 bg-red-50 border border-red-200 rounded">
          ...
          <div className="mt-2 w-full">
            <div className="flex items-center justify-center gap-1 sm:gap-2 w-full px-2 py-1 sm:px-3 sm:py-2 bg-blue-50 border border-blue-200 rounded">
